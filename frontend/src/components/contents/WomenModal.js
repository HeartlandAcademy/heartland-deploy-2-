...
import { createWTestimonials } from "../../actions/testimonialsActions";
import Loader from "./Loader";
import Message from "./Message";

export default function WomenModal(props) {
  ...
  const { success, error } = womenTestimonialsCreate;
  ...
  const submitHandler = (event) => {
    ...
    if (form.checkValidity() === false) {
      ...
      dispatch(createWTestimonials(fullName, desc, womenImage, message));
    }
    setValidated(true);
  };
