...
const AdminAllGallery = () => {
  ...
  const galleryWAlbumDelete = useSelector((state) => state.galleryWAlbumDelete);
  const { success, error: deleteError } = galleryWAlbumDelete;
  ...
  const albumDeleteHandler = (id) => {
    if (window.confirm("Are you sure")) {
      dispatch(deleteWGalleryAlbums(id));
...
export default AdminAllGallery;
